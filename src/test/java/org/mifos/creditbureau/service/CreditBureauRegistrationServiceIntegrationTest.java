...
@DataJpaTest
@Import({
  CreditBureauRegistrationWriteServiceImpl.class,
  CreditBureauRegistrationReadImplService.class,
  EncryptionService.class,
  org.mifos.creditbureau.config.BouncyCastleConfig.class,
  CreditBureauMapper.class
})
class CreditBureauRegistrationServiceIntegrationTest {

  @Autowired private CreditBureauRegistrationWriteService writeService;

  @Autowired private CreditBureauRegistrationReadService readService;

  @Autowired private CreditBureauRepository creditBureauRepository;

  @Autowired private CreditBureauMapper mapper;
  ...
  public void init() {
    ...
    creditBureauDataParams =
        CBRegisterParamsData.builder()
  ...
  @Test
  @DisplayName(
      "Can create and save a credit bureau, created credit bureau should have also have created ")
