...
public class CreditBureauRegistrationApiResource {
  ...
  public CreditBureauRegistrationApiResource(
      ...
      CBRegisterParamRepository cbRegisterParamRepository,
      CBRegisterParamRepository cbRegisterParamRepository1) {
  ...
  public List<CreditBureauSummary> getAllCreditBureaus() {
    ...
    List<CreditBureauData> creditBureaus =
        Optional.ofNullable(this.creditBureauRegistrationReadService.getAllCreditBureaus())
  ...
  public Response createCreditBureau(CreditBureauData creditBureauData) {
    CreditBureau createdCreditBureau =
        creditBureauRegistrationWriteService.createCreditBureau(creditBureauData);
    CreditBureauSummary summary =
        new CreditBureauSummary(
            createdCreditBureau.getId(), createdCreditBureau.getCreditBureauName());
  ...
  public List<String> getConfigParamKeys(
      @PathParam("id")
          Long organizationCreditBureauId) { // Fetch the configuration parameters for the given ID
    // Call the service layer to get the parameters DTO
    List<String> creditBureauParamKeys =
        this.creditBureauRegistrationReadService.getCreditBureauParamKeys(
  ...
  public Response configureCreditBureauParams(
      @PathParam("id") Long id, CBRegisterParamsData cbRegisterParamsData) {
    CBRegisterParams createdCBParams =
        creditBureauRegistrationWriteService.configureCreditBureauParamsValues(
            id, cbRegisterParamsData);
  ...
  public Map<String, String> getCBRegisterParamsById(@PathParam("id") Long id) {
    Map<String, String> cbRegisterParams =
        creditBureauRegistrationReadService.getRegistrationParamMap(id);
