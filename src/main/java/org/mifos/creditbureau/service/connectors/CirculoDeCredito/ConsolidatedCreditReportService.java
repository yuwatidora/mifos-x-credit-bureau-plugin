...
public class ConsolidatedCreditReportService {
  ...
  public ResponseEntity<String> testRCCSandboxEndpoint(Long creditBureauId) throws Exception {
    ...
    // request body
    CirculoDeCreditoRCCRequest request =
        CirculoDeCreditoRCCRequest.builder()
            .primerNombre("JUAN")
    ...
    Map<String, String> keys =
        creditBureauRegistrationReadService.getRegistrationParamMap(
            creditBureauId); // need to know th id
