...
@Service
@AllArgsConstructor
public class CreditBureauRegistrationReadImplService
    implements CreditBureauRegistrationReadService {
  ...
  public CBRegisterParamsData getCreditBureauParams(Long creditBureauId) {
    return cbRegisterParamRepository
        .findById(creditBureauId)
