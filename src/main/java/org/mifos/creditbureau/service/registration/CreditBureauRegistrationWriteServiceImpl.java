...
public class CreditBureauRegistrationWriteServiceImpl
  ...
  public CreditBureau createCreditBureau(CreditBureauData creditBureauData) {
    ...
    cbRegisterParams.setRegistrationParams(
        new HashMap<>(registrationParams)); // Create a new HashMap to ensure JPA detects the change
  ...
  * */
  public CBRegisterParams configureCreditBureauParamsValues(
      Long bureauId, CBRegisterParamsData cbRegisterParamsData) { // takes a dto
    CBRegisterParams existingParams =
        CBRegisterParamRepository.findById(bureauId)
            .orElseThrow(
                () ->
                    new EntityNotFoundException("CBRegisterParams not found with id: " + bureauId));
  ...
  public void configureCreditBureauParamsKeys(
      Long bureauId, CBRegisterParamsData cbRegisterParamsData) {
